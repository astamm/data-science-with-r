...
knitr::include_graphics("~/Downloads/pca-decathlon.png")
```
</div>
...
- Navigate into the `12-PCA` folder of the `12-PCA` project on RStudio Cloud.
- Open the file `12-PCA-Exercises.Rmd` and perform the PCA analyses for the proposed data sets.
