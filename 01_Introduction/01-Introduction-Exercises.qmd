...
This is a Quarto file. It contains plain text interspersed with grey chunks of code. You can use the file to take notes _and_ run code. For example, you can write your name on the line below. Try it: 
...
By the way, you only need to use code comments _inside_ of code chunks. R knows not to try to run the text that you write outside of code chunks. You can press *Cmd+Shift+C* to comment or uncomment a line of code.
