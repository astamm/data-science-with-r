...
<!-- ::: {.callout-important title="Final Exam (2025-01-16)"}
Exercises

: The main document that you have to work on is
[here](Evaluations/2024_2025/03_Final_Exam/FinalExam_20250116.qmd).

Data Sets

: All data sets are available at
[here](Evaluations/2024_2025/03_Final_Exam/FinalExam_Data.zip). The ZIP file
contains two files: an RDS file and a CSV file.

Deliverable

: All you have to do is send the QMD file with your answers and your name as
author by mail to the instructor by 12:25pm on 2025-01-16.
:::

::: {.callout-important title="Homework Assignment (2025-01-01)"}
New announcement about the homework assignment.

Deliverable is expected to be a ZIP archive containing the two `.qmd` files
(report and dashboard) along with all the necessary data files.

Please ensure that both files compile withour error.

Checkout the [homework assignment
page](Evaluations/2024_2025/02_Homework/project.qmd).
::: -->
...
- Specific R packages by theme: 
    ...
    - Data sets:
        ...
        - [{ncyflights13}](https://nycflights13.tidyverse.org): information about all flights that departed from NYC (e.g. EWR, JFK and LGA) to destinations in the United States, Puerto Rico, and the American Virgin Islands) in 2013: 336,776 flights in total.
    
    - Data wrangling:

        - [{janitor}](https://sfirke.github.io/janitor/): simple functions for examining and cleaning dirty data.
        - [{skimr}](https://docs.ropensci.org/skimr/): a frictionless approach to summary statistics which conforms to the principle of least surprise, displaying summary statistics the user can skim quickly to understand their data.
        - [{tidyverse}](https://www.tidyverse.org): an opinionated collection of R packages designed for data science.
    
    - Extra data visualization packages:
        
        - [{ggcorrplot}](https://rpkgs.datanovia.com/ggcorrplot/): visualize easily a correlation matrix using 'ggplot2'.
        - [{ggfortify}](https://github.com/sinhrks/ggfortify): unified plotting tools for statistics commonly used, such as GLM, time series, PCA families, clustering and survival analysis.
        - [{plotly}](https://plotly.com/r/): an interactive plotting library.
    
    - Reporting

        - [{DT}](https://rstudio.github.io/DT/): an R interface to the JavaScript library [DataTables](https://datatables.net).
        - [{gt}](https://gt.rstudio.com/index.html): produce nice-looking display tables.
        - [{kableExtra}](https://haozhu233.github.io/kableExtra/): construct complex table with `knitr::kable() + |>`.
    ...
    <!-- - PCA:
        ...
        - [{umap}](https://github.com/tkonopka/umap):  an interface to the UMAP algorithm in R for dimension reduction, including a translation of the original algorithm into R with minimal dependencies. -->
